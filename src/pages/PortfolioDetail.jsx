...
import near from '../assets/icons/tech/near.svg';
...
import nearbook1 from '../assets/images/detail-portfolio/near-book-1.png';
import nearbook2 from '../assets/images/detail-portfolio/near-book-2.png';
import nearbook3 from '../assets/images/detail-portfolio/near-book-3.png';
import nearbook4 from '../assets/images/detail-portfolio/near-book-4.png';
    ...
    <div className="dark:bg-darkmode">
      ...
      <section>
        <div className="max-w-3xl mx-auto px-4 py-10">
          <h1 className="font-bold text-xl text-center mb-4 dark:text-blue-400">
            {name}
          </h1>
          <p className="text-justify mb-8 dark:text-gray-200">{desc}</p>
          <div className="flex flex-wrap justify-between gap-4">
            <div className="flex inline-flex items-center gap-2">
              <h4 className="font-bold py-2 px-2 rounded-md khaki-2 dark:bg-grey dark:text-gray-200">
                WEBSITE
              </h4>
              <a
                className={
                  website === 'in development'
                    ? `py-2 px-2 rounded text-yellow-100 bg-green-500`
                    : `text-blue-400 hover:underline md:mr-48 dark:text-pink-400`
                }
                href={link}
                target="blank"
              >
              ...
              {website === 'in development' ? (
                <span
                  className="py-2 px-2 rounded text-yellow-100 bg-pink-400 dark:text-gray-200"
                  target="blank"
                >
                  84%
                </span>
              ...
              {name === 'PT. HIS Corp Intern' ? (
                ...
                <div className="flex flex-wrap justify-between gap-4">
                  ...
                  <a href="https://near.org/" target="_blank" rel="noreferrer">
                    <img src={near} width="50" alt="React.js" />
                  </a>
                </div>
              ) : null}
              {name === 'Aleem' ? (
          ...
          {name === 'Store GG' ? (
            ...
            <>
              <div className="my-10 mx-auto">
                <img className="mb-4 rounded-md" src={nearbook1} alt="" />
                <img className="mb-4 rounded-md" src={nearbook2} alt="" />
                <img className="mb-4 rounded-md" src={nearbook3} alt="" />
                <img className="mb-4 rounded-md" src={nearbook4} alt="" />
              </div>
            </>
          ) : null}
        </div>
