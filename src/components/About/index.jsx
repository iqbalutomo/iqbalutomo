...
export default function About() {
  return (
    <div class="max-w-3xl mx-auto">
      <div class="py-4 rounded-xl khaki-2 text-brown text-2xl text-center font-extrabold dark:bg-grey dark:text-blue-400">
        <h1>Hi, I'm Iqbal.</h1>
      </div>
      <div class="flex flex-wrap md:flex-nowrap gap-4 justify-center mt-10">
        <div class="flex flex-col md:w-1/3 items-center">
          ...
          <h2 class="font-bold text-xl mt-2 dark:text-gray-200">Muhlis Iqbal Utomo</h2>
          <p class="dark:text-gray-200">Front End Developer</p>
        </div>
        <div class="flex flex-col md:w-2/3 text-justify dark:text-gray-200">
          <p>
